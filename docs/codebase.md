...
| `src/render/` | Per-tier frame composition: reference grid, orbit rings, star dots, galaxy-density glow, galaxy-field sprites / labels, body name labels, the HUD scale bar, and the selection reticle. |
